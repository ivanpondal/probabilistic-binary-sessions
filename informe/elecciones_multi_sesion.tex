...
que futuras elecciones presentes tanto en $\ContextA$ como en $\ContextB$ se
verán ajustadas como efecto de la elección recibida en $x$. La regla
\rulename{t-choice} permite tipar elecciones probabilísticas combinando la
evolución ambos contextos mediante $\csum[p]$.
