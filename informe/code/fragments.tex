...
\newcommand{\TwoSessionsInvalidPickBothBranches}[1][]{\InputOCamlC[firstline=75,lastline=85,#1]{code/ProFuse.ml}}
\newcommand{\TwoSessionsPickTwo}[1][]{\InputOCamlC[firstline=89,lastline=101,#1]{code/ProFuse.ml}}
